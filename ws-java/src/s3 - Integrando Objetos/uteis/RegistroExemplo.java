...
public class RegistroExemplo {
    ...
    private Aluno[] registrarAlunosExemplo() {
        ...
        alunos[0] = new Aluno("André", new DateType(1, 2, 2004), new double[]{7.5, 6.4, 5.6, 9.2, 8.9});
        alunos[1] = new Aluno("Bianca", new DateType(3, 4, 2003), new double[]{7.3, 5.2, 6.9, 8.4, 8.6});
        alunos[2] = new Aluno("Carla", new DateType(7, 2, 2003), new double[]{9.6, 8.2, 9.4, 9.3, 10.0});
        alunos[3] = new Aluno("Dagoberto", new DateType(9, 9, 2004), new double[]{5.6, 6.5, 6.3, 7.2, 7.1});
        alunos[4] = new Aluno("Eduardo", new DateType(10, 6, 2003), new double[]{9.6, 9.2, 8.7, 8.3, 8.9});
        alunos[5] = new Aluno("Fábio", new DateType(15, 4, 2003), new double[]{7.6, 6.7, 7.8, 8.9, 9.2});
        alunos[6] = new Aluno("Gabriela", new DateType(20, 5, 2003), new double[]{7.3, 7.5, 7.5, 8.5, 9.0});
        alunos[7] = new Aluno("Giovani", new DateType(16, 5, 2003), new double[]{7.6, 8.2, 8.3, 8.5, 8.9});
        alunos[8] = new Aluno("Heitor", new DateType(5, 7, 2003), new double[]{8.5, 8.7, 8.5, 8.6, 8.2});
        alunos[9] = new Aluno("Irineu", new DateType(9, 10, 2003), new double[]{9.2, 9.3, 9.4, 9.5, 9.6});
        alunos[10] = new Aluno("Jorel", new DateType(23, 2, 2003), new double[]{10.0, 10.0, 9.9, 9.8, 9.8});
        alunos[11] = new Aluno("Katielly", new DateType(4, 7, 2003), new double[]{7.8, 7.9, 7.9, 8.0, 6.5});
        alunos[12] = new Aluno("Lucíola", new DateType(15, 5, 2003), new double[]{9.2, 9.3, 9.6, 9.5, 9.1});
        alunos[13] = new Aluno("Morrice", new DateType(17, 2, 2003), new double[]{5.6, 7.2, 7.5, 7.5, 7.4});
        alunos[14] = new Aluno("Norma", new DateType(20, 3, 2003), new double[]{6.7, 6.8, 6.7, 7.2, 7.5});
